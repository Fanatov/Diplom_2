...
class TestOrderCreate:
    ...
    def test_order_create_not_auth_user(self): #Баг. Обратиться к Иксанову Камилу, руководителю текущей когорты.
    ...
    @allure.description('Проверка на ошибки, соответствие статус-кода')
